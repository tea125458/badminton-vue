    ...
    // ============================
    {
      ...
      children: [
        { path: '', name: 'home', component: () => import('@/views/frontend/HomePage.vue') },
        {
          path: 'products',
          name: 'products',
          component: () => import('@/views/frontend/ProductBrowse.vue'),
        },
        { path: 'cart', name: 'cart', component: () => import('@/views/frontend/ProductCart.vue') },
        {
          path: 'booking',
          name: 'booking',
          component: () => import('@/views/frontend/BookingPage.vue'),
        },
        {
          path: 'pickup',
          name: 'pickup',
          component: () => import('@/views/frontend/PickupGamePage.vue'),
        },
        {
          path: 'pickup/:id',
          name: 'pickupDetail',
          component: () => import('@/views/frontend/PickupGameDetail.vue'),
        },
        {
          path: 'login',
          name: 'memberLogin',
          component: () => import('@/views/frontend/MemberLogin.vue'),
        },
        {
          path: 'register',
          name: 'memberRegister',
          component: () => import('@/views/frontend/MemberRegister.vue'),
        },
        {
          path: 'reset-password',
          name: 'resetPassword',
          component: () => import('@/views/frontend/MemberResetPwd.vue'),
        },
        {
          path: 'profile',
          name: 'profile',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: 'courts',
          name: 'courtManage',
          component: () => import('@/views/admin/CourtManage.vue'),
        },
        {
          path: 'bookings',
          name: 'bookingManage',
